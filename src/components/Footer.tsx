      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
        ...
        <div>
          ...
          <ul className="list-none flex flex-col gap-2">
            ...
            <li><a href="https://retail.zaderitechnologies.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm no-underline hover:text-foreground transition-colors">Retail System Login</a></li>
          </ul>
        </div>
      </div>
