    ...
    <>
      ...
      {theme === "dark" && (
        <nav
          ...
          style={{
            background: scrolled
              ? "linear-gradient(90deg, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0) 30%, hsla(213,60%,35%,0.9) 100%)"
              : "linear-gradient(90deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 30%, hsla(213,60%,30%,0.8) 100%)"
          }}
        >
